...
from speaker_verify.dataset import (download_librispeech, scan_speakers,
                                     generate_pairs, build_concat_dataset)
...
def main():
    ...
    print(f"  (80-dim = [emb_A || emb_B] concatenated embeddings)")
    ...
    print(f"  Input: [emb_A || emb_B] (80-dim concatenated)")
    print(f"  Both voiceprints encrypted together for FHE comparison")
